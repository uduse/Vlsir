...
_OPRESULT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="raw",
            full_name="vlsir.spice.OpResult.raw",
            index=3,
            number=6,
            type=9,
            cpp_type=9,
